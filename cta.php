...
define('CTA_CURRENT_VERSION', '1.3.0' );
define('CTA_URLPATH', WP_PLUGIN_URL.'/'.plugin_basename( dirname(__FILE__) ).'/' );
define('CTA_PATH', WP_PLUGIN_DIR.'/'.plugin_basename( dirname(__FILE__) ).'/' );
define('CTA_SLUG', plugin_basename( dirname(__FILE__) ) );
define('CTA_FILE', __FILE__ );
define('CTA_TEXT_DOMAIN', 'cta' );

$uploads = wp_upload_dir();
define('CTA_UPLOADS_PATH', $uploads['basedir'].'/wp-calls-to-action/templates/' );
define('CTA_UPLOADS_URLPATH', $uploads['baseurl'].'/wp-calls-to-action/templates/' );
define('CTA_STORE_URL', 'http://www.inboundnow.com/cta/' );
