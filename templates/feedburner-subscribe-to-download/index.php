...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $path; ?>css/app-bootstrap.css">
  <!--[if lt IE 9]>
...
<div id="content" style="width:<?php echo $width;?>px;height:<?php echo $height;?>px; margin: auto;">
  ...
  <div id="inbound-share-model">
      <form name="feedburnerform" id="feedburnerform">
        ...
        <input type="hidden" name="rurl" value="<?php echo $download_url; ?>">
        <input type="hidden" name="feedburner" value="<?php echo $share_url; ?>">

        <div style="padding-bottom:5px;">
        <input name="email" id="newsletter-text" type="text" maxlength="100" style="width:175px !important" placeholder="Email Your Email" value="" class=""></div>
        <div><button type="submit" id="SubLink" class="btn primary large bold">Subscribe via Email</button></div>
    </form>
