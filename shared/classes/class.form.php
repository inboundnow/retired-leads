...
<table cellpadding="0" cellspacing="0" border="0" align="center" style="border-collapse:collapse;width:600px;font-size:13px;line-height:20px;color:#545454;font-family:Arial,sans-serif;margin-top:0;margin-right:auto;margin-bottom:0;margin-left:auto">
	...
	public static function get_countries_array() {
		return array (
			...
			__('AN' , 'leads' ) => __('Netherlands Antilles', 'leads' ),
			...
			__('BN' , 'leads' ) => __('Brunei', 'leads' ),
			__('BO' , 'leads' ) => __('Bolivia', 'leads' ),
			__('BQ' , 'leads' ) => __('British Antarctic Territory', 'leads' ),
			...
			__('CD' , 'leads' ) => __('Congo - Kinshasa', 'leads' ),
			__('CF' , 'leads' ) => __('Central African Republic', 'leads' ),
			__('CG' , 'leads' ) => __('Congo - Brazzaville', 'leads' ),
			...
			__('CS' , 'leads' ) => __('Serbia and Montenegro', 'leads' ),
			__('CT' , 'leads' ) => __('Canton and Enderbury Islands', 'leads' ),
			...
			__('DD' , 'leads' ) => __('East Germany', 'leads' ),
			...
			__('FM' , 'leads' ) => __('Micronesia', 'leads' ),
			__('FO' , 'leads' ) => __('Faroe Islands', 'leads' ),
			__('FQ' , 'leads' ) => __('French Southern and Antarctic Territories', 'leads' ),
			__('FR' , 'leads' ) => __('France', 'leads' ),
			__('FX' , 'leads' ) => __('Metropolitan France', 'leads' ),
			...
			__('HK' , 'leads' ) => __('Hong Kong SAR China', 'leads' ),
			__('HM' , 'leads' ) => __('Heard Island and McDonald Islands', 'leads' ),
			...
			__('JT' , 'leads' ) => __('Johnston Island', 'leads' ),
			...
			__('PM' , 'leads' ) => __('Saint Pierre and Miquelon', 'leads' ),
			__('PN' , 'leads' ) => __('Pitcairn Islands', 'leads' ),
			__('PR' , 'leads' ) => __('Puerto Rico', 'leads' ),
			__('PS' , 'leads' ) => __('Palestinian Territories', 'leads' ),
			__('PT' , 'leads' ) => __('Portugal', 'leads' ),
			__('PU' , 'leads' ) => __('U.S. Miscellaneous Pacific Islands', 'leads' ),
			__('PW' , 'leads' ) => __('Palau', 'leads' ),
			__('PY' , 'leads' ) => __('Paraguay', 'leads' ),
			__('PZ' , 'leads' ) => __('Panama Canal Zone', 'leads' ),
			__('QA' , 'leads' ) => __('Qatar', 'leads' ),
			__('RE' , 'leads' ) => __('Réunion', 'leads' ),
			__('RO' , 'leads' ) => __('Romania', 'leads' ),
			__('RS' , 'leads' ) => __('Serbia', 'leads' ),
			__('RU' , 'leads' ) => __('Russia', 'leads' ),
			...
			__('SJ' , 'leads' ) => __('Svalbard and Jan Mayen', 'leads' ),
			__('SK' , 'leads' ) => __('Slovakia', 'leads' ),
			...
			__('ST' , 'leads' ) => __('São Tomé and Príncipe', 'leads' ),
			__('SU' , 'leads' ) => __('Union of Soviet Socialist Republics', 'leads' ),
			...
			__('UM' , 'leads' ) => __('U.S. Minor Outlying Islands', 'leads' ),
			__('UY' , 'leads' ) => __('Uruguay', 'leads' ),
			__('UZ' , 'leads' ) => __('Uzbekistan', 'leads' ),
			__('VA' , 'leads' ) => __('Vatican City', 'leads' ),
			__('VC' , 'leads' ) => __('Saint Vincent and the Grenadines', 'leads' ),
			__('VD' , 'leads' ) => __('North Vietnam', 'leads' ),
			__('VE' , 'leads' ) => __('Venezuela', 'leads' ),
			__('VG' , 'leads' ) => __('British Virgin Islands', 'leads' ),
			__('VI' , 'leads' ) => __('U.S. Virgin Islands', 'leads' ),
			__('VN' , 'leads' ) => __('Vietnam', 'leads' ),
			__('VU' , 'leads' ) => __('Vanuatu', 'leads' ),
			__('WF' , 'leads' ) => __('Wallis and Futuna', 'leads' ),
			__('WK' , 'leads' ) => __('Wake Island', 'leads' ),
			__('WS' , 'leads' ) => __('Samoa', 'leads' ),
			__('YD' , 'leads' ) => __('People\'s Democratic Republic of Yemen', 'leads' ),
			...
			__('ZZ' , 'leads' ) => __('Unknown or Invalid Region', ' leads' )
		);
	}
