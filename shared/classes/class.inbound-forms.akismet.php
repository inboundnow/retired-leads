	...
	class Inbound_Akismet {
		...
		private function load_hooks() {
			...
			if (get_option('inbound_forms_enable_akismet' , '1' )) {
				...
				add_action( 'inbound_store_lead_pre' , array( __CLASS__ , 'check_is_spam' ) , 10 , 1 ); /* On store lead ajax */
				add_filter( 'form_actions_spam_check' , array( __CLASS__ , 'check_is_spam' ) , 10 , 1 ); /* On form email actions */
			}
		}
