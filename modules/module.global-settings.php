...
function wpleads_get_global_settings() {
	...
	array(
		array(
			'id'  => 'tracking-ids',
			'label' => __('IDs of forms to track' , 'leads' ),
			'description' => __("<p>Enter in a value found in a HTML form's id attribute to track it as a conversion.</p><p>Do not include the # in the id. <strong>Example format: Form_ID, Form-ID-2</strong></p><p>Gravity Forms, Contact Form 7, and Ninja Forms are automatically tracked (no need to add their IDs in here). Comma separated values</p>" , 'leads' ),
			'type'  => 'text',
			'default'  => '',
			'options' => null
		),
