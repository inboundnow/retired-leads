...
add_action( 'added_post_meta', 'wpleads_after_post_meta', 10, 4 );
add_action( 'updated_post_meta', 'wpleads_after_post_meta', 10, 4 );
function wpleads_after_post_meta( $meta_id, $post_id, $meta_key, $meta_value )
{
